...
1.Calculate the sum of first k elements from left side and store it in leftSum.
2.Initialize rightSum = 0 and maxSum = leftSum. 
3.Now remove each element from last at front and add every element from last at rightmost end.
4. Update maxSum with the maximum of maxSum and leftSum + rightSum.
